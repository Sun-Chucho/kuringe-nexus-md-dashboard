const companies = [
  ['Redstone', 'Nightclub', 'https://www.redstonenightclubtz.com/md', 'assets/logos/redstone.png'],
  ['Real Estate', 'Property', 'https://kuringe-real-estate.vercel.app/MD', 'assets/logos/real-estate.png'],
  ['Mawio', 'Hospitality', 'https://mawio.vercel.app/MD', 'assets/logos/mawio.png'],
  ['Lighthouse', 'Hotel · Moshi', 'https://www.lighthousemoshi.com/md', 'assets/logos/lighthouse.jpg'],
  ['Halls Moshi', 'Events & Halls', 'https://kuringehallsmoshi.com/md', 'assets/logos/halls-moshi.ico'],
  ['Orange', 'Hotel · Arusha', 'https://www.orangehotelarusha.com/md', 'assets/logos/orange-hotel.jpeg'],
  ['Mbezi', 'Events & Halls', 'https://www.kuringehallsmbezi.com/md', 'assets/logos/halls-mbezi.ico'],
  ['Casa', 'Hospitality', 'https://casa-cyan-psi.vercel.app/md', 'assets/logos/casa.png']
];
const grid = document.querySelector('#companyGrid');
grid.innerHTML = companies.map(([name, category, url, logo]) => {
  return `<a class="card" href="${url}" aria-label="Open ${name} management system">
    <div class="card-header"><div class="logo-stage"><img class="company-logo" src="${logo}" alt="${name} logo"></div><span class="open-icon">↗</span></div>
